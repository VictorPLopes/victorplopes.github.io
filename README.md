...
**Feel free to make suggestions and contributions**, or fork the repository to use as a template, just **credit me with the proper attribution** if you do that.

If you fork this repository, or copy parts of it for your own public project, you must visibly link back to this repository or my [page](https://victorplopes.github.io/).

## Installation and Setup

### Pre-requisites

- [Node.js](https://nodejs.org/en/download/current) - v20.19.0 or newer
- [Angular CLI](https://angular.dev/installation) - v21 or newer

### Running a Development Server

After cloning this repository to your machine, open its directory. To start a local development server, run:
